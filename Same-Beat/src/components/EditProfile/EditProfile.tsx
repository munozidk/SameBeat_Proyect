...
export default function EditProfile({ initialData, onSave }: Props) {
  ...
  const [toggles, setToggles] = useState<Toggle[]>([
    ...
    { id: 'location', label: 'Mostrar ubicacion', value: false }
  ])
  ...
  return (
    <div className="edit-profile">
      ...
      <div className="edit-profile__photo-section">
        ...
        <button className="edit-profile__photo-btn">
          Editar Foto
        </button>
      ...
      <div className="edit-profile__toggles">
        ...
        {toggles.map(toggle => (
          ...
          <div
            key={toggle.id}
            className="edit-profile__toggle-row"
          >

            <span className="edit-profile__toggle-label">
              {toggle.label}
            </span>
